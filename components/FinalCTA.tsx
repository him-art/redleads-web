...
const WaitlistCTA = () => {
  return (
    <section id="pricing" className="relative overflow-hidden bg-[#1a1a1a] py-24 border-t border-white/5">
      ...
      <div className="absolute top-0 left-0 -translate-x-1/2 -translate-y-1/2 rounded-full bg-orange-500/5 p-32 opacity-50" />
      <div className="absolute bottom-0 right-0 translate-x-1/2 translate-y-1/2 rounded-full bg-orange-500/5 p-32 opacity-50" />
      ...
      <div className="relative mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
        ...
        <p className="mx-auto mt-6 max-w-2xl text-lg text-gray-400">
          Join {FOUNDER_COUNT} founders who stopped manually searching Reddit. Start your 7-day full access trial — no card required.
        </p>
