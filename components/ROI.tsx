                ...
                <div className="bg-[#0c0c0c] rounded-[3rem] p-8 md:p-16 border border-white/5 relative overflow-hidden shadow-none">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
                            ...
                            <div className="flex flex-col items-center justify-center text-center">
                                ...
                                <div className="w-full p-2 bg-green-500/5 border border-green-500/10 rounded-[2.5rem]">
                                    <div className="w-full bg-[#080808] border border-green-500/20 rounded-[2rem] p-8 relative overflow-hidden group hover:bg-[#0c0c0c] transition-colors shadow-none">
