...
export default function StickyLeadMagnet() {
  ...
  return (
    <AnimatePresence>
      ...
      >
        <div className="bg-[#1a1a1a] border border-orange-500/30 shadow-[0_0_40px_rgba(249,115,22,0.15)] rounded-2xl p-4 md:p-5 flex items-center gap-4 relative overflow-hidden group">
          ...
          {/* Icon */}
          <div className="shrink-0 w-12 h-12 bg-orange-500/10 rounded-xl flex items-center justify-center border border-orange-500/20 group-hover:bg-orange-500/20 transition-colors">
             <MaterialIcon name="travel_explore" size={24} className="text-orange-500" />
          </div>
          ...
          <div className="flex-1">
            ...
            <Link 
              ...
              className="inline-flex items-center gap-2 px-4 py-2 bg-orange-500 hover:bg-orange-600 text-white text-[10px] font-black uppercase tracking-widest rounded-lg transition-colors shadow-lg shadow-orange-500/20"
            >
